...
" Vim color file - blank
" Generated by http://bytefluent.com/vivify 2013-09-24
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Folded guifg=#00CD00 guibg=NONE  guisp=NONE gui=NONE ctermfg=240 ctermbg=NONE cterm=NONE
...
hi StatusLineNC guifg=#cccccc guibg=#1874CD guisp=#145b7d gui=NONE ctermfg=8 ctermbg=232 cterm=NONE
...
hi Todo guifg=#FFFF00 guibg=#272822 guisp=#272822 gui=bold ctermfg=15 ctermbg=235 cterm=bold
...
hi Search guifg=#ffffff guibg=#fcaf17 guisp=#fcaf17 gui=NONE ctermfg=15 ctermbg=240 cterm=NONE
...
hi Comment guifg=#b8a969 guibg=NONE guisp=NONE gui=NONE ctermfg=143 ctermbg=NONE cterm=NONE
...
hi VertSplit guifg=#CCCCCC guibg=#080808 guisp=#080808 gui=bold ctermfg=8 ctermbg=232 cterm=bold
